...
<nav class="sticky-top navbar navbar-expand-lg navbar-dark ">
    <a class="navbar-brand" href="../../Dojo/index.php"><img id="logo" src="../images/rocket.png" alt="logo" height="auto" width="100px"/></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            <a class="nav-item nav-link" href="../../Dojo/index.php">Accueil <span class="sr-only">(current)</span></a>
